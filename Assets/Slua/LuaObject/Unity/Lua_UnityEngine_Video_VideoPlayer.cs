...
public class Lua_UnityEngine_Video_VideoPlayer : LuaObject {
	...
	static public int set_source(IntPtr l) {
		try {
			...
			v = (UnityEngine.Video.VideoSource)LuaDLL.luaL_checkinteger(l, 2);
			self.source=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_renderMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.Video.VideoRenderMode)LuaDLL.luaL_checkinteger(l, 2);
			self.renderMode=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_aspectRatio(IntPtr l) {
		try {
			...
			v = (UnityEngine.Video.VideoAspectRatio)LuaDLL.luaL_checkinteger(l, 2);
			self.aspectRatio=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_timeSource(IntPtr l) {
		try {
			...
			v = (UnityEngine.Video.VideoTimeSource)LuaDLL.luaL_checkinteger(l, 2);
			self.timeSource=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_audioOutputMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.Video.VideoAudioOutputMode)LuaDLL.luaL_checkinteger(l, 2);
